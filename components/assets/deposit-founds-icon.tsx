export const DepositFoundsIcon = () => {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      />
      <path
        d="M16 11.9001C17.6016 11.9001 18.9 10.6017 18.9 9.0001C18.9 7.39847 17.6016 6.1001 16 6.1001C14.3984 6.1001 13.1 7.39847 13.1 9.0001C13.1 10.6017 14.3984 11.9001 16 11.9001Z"
        stroke="#2D274B"
        stroke-width="2"
        stroke-linecap="round"
        stroke-linejoin="round"
