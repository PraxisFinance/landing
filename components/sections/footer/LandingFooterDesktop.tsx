...
export function LandingFooterDesktop() {
  return (
    <div className="mx-auto flex w-full max-w-screen-2xl flex-1 flex-col px-[20px] sm:px-6 lg:min-h-0 lg:px-10">
      <div className="flex flex-col rounded-t-[2rem] bg-brand-gray/90 p-[50px] pb-[20px] lg:flex lg:min-h-[416px] lg:flex-1 lg:flex-col">
        <div className="grid flex-1 grid-cols-[minmax(0,240px)_1fr] items-stretch gap-x-12 gap-y-10 lg:min-h-0">
